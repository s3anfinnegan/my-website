...
const Career = () => {
  const data = [
    { year: 2019, milestone: "I finished secondary school in 2019 and went to study engineering at University of Galway. My favourite subjects in school were all languages but I had a huge personal interest in technology and business so engineering seemed like the best path forward.", growth: 10 },
    { year: 2019, milestone: "When I started my degree I knew I wanted to use the resources around me to build something so, with two mates (Joe and Luke), I co-founded Receipt Relay - the easiest way to get your e-receipt.", growth: 20 },
    ...
    { year: 2022, milestone: "For my work placement module in third year, I started working full-time on Receipt Relay and we signed up more local businesses. During this time, we secured an LOI from a major European retailer but ultimately failed to reach PMF and decided to close down our operations. After some serious introspection, I decided to return to college for my final year.", growth: 60 },
    { year: 2023, milestone: "I graduated from my degree in electronic and computer engineering. For the summer after college I worked on a bar and did some travelling around the US and Europe. I gave a lot of consideration to what I wanted to do next.", growth: 70 },
    { year: 2023, milestone: "After returning from the US at the end of the summer, I interviewed for a grad role with Fidelity Investments and got an offer for January 2024. For the few months before starting at Fidelity, I joined an edtech startup called Breakthrough Maths as their third engineering hire and worked under a brilliant CTO. I also ran my first half marathon.", growth: 80 },
    ...
    { year: 2025, milestone: "I was promoted to the equivalent of Engineer II and in my spare time I started working on a lot side projects. I travelled to Indonesia, visited family in Sydney and thru-hiked the Maumturks during the summer in Galway.", growth: 100 },
    { year: 2026, milestone: "I reached two years experience as a software engineer in January.", growth: 110 }
  ];
